...
def default_strategy_registry() -> StrategyRegistry:
	...
	from src.miniqs.strategies.mean_reversion import MeanReversionStrategy
	from src.miniqs.strategies.momentum import MomentumStrategy
	from src.miniqs.strategies.volatility_breakout import VolatilityBreakoutStrategy
	from src.miniqs.strategies.trend_robust import TrendRobustStrategy
	from src.miniqs.strategies.hyper_v5 import HyperV5Strategy
	...
	registry.register(TrendRobustStrategy())
	registry.register(HyperV5Strategy())
	return registry
